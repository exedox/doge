...
RUN git clone --depth=1 https://github.com/wowsuchdoge/doge /doge && git clone --depth=1 https://github.com/ItsCinnabar/nut/tree/fix /doge/nut && apk del zlib-dev git alpine-sdk libffi-dev musl-dev openssl-dev
